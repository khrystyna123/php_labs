...
<div class="container">
    <form method="post">
        ...
        <div class="col-75">
            <input type="number" name="price_model" />
        </div>
        ...
        <div class="col-75">
            <input type="text" name="model_sale" />
        </div>

        <div class="col-25">
            <label>Iм'я покупця: </label>
        </div>
        <div class="col-75">
            <input type="text" name="firstname_sale" />
        </div>

        <div class="col-25">
            <label>Прізвище покупця: </label>
        </div>
        <div class="col-75">
            <input type="text" name="lastname_sale" />
        </div>
